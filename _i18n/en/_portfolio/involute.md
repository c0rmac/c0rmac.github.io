...
1. <del>[**Theoretical Basis:** Understanding CBO and its link with Stochastic Gradient Descent](https://github.com/c0rmac/involute/blob/main/docs/theory.md)</del>
2. [**Test Results:** Benchmarks and convergence performance on high-dimensional manifolds](https://github.com/c0rmac/involute/blob/main/docs/benchmarks.md)
3. [**Library Documentation**](https://github.com/c0rmac/involute/blob/main/docs/lib_docs.md)
4. [**Advanced Setup:** Customizing the Adam adapter and backend routing for SYCL/oneMKL](https://github.com/c0rmac/involute/blob/main/docs/advanced_setup.md)
...
See the <a href='https://github.com/c0rmac/involute/blob/main/docs/lib_docs/math.md'>Math API documentation</a> for more information.
