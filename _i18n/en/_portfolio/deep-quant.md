...
* [**`Base Theory: SDEs and Path Signatures`**](https://github.com/c0rmac/deep-quant/blob/main/docs/BASE_THEORY.md)**:** The technical details motivating much of the library's foundations.

* [**`Neural Network Solvers`**](https://github.com/c0rmac/deep-quant/blob/main/docs/NN_THEORY.md)**:** The technical details driving the implementation of the neural network and kernel solvers.

* [**`Challenges & Enhancements`**](https://github.com/c0rmac/deep-quant/blob/main/docs/ENHANCEMENTS.md)**:** The technical details describing how challenges were uncovered and how enhancements were made to solve them.
