...
`qtexture` is a lightweight Python library for calculating resource monotones from the theory of **Quantum State Texture**. It provides a robust, numerically stable, and easy-to-use interface for researchers and students in quantum information science.
...
## Library Validation
A comprehensive series of tests were done in order to validate the results of the library. Information about these tests can be found [here](https://github.com/c0rmac/qtexture/blob/main/VALIDATION_EXAMPLE.md).
