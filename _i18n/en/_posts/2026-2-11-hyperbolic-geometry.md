...
date: 2026-2-11
permalink: /posts/2022/2/11/2026-2-11-hyperbolic-geometry/
tags:
  - hyperbolic geometry
...
The name refers to two different physical theories:
* **AdS (Anti-de Sitter space)**: This is the "bulk" universe, which is a solution to Einstein's equations of general relativity with a negative cosmological constant. 
* **Hyperbolic Geometry in AdS**: Geometrically, AdS space is essentially hyperbolic space equipped with a time dimension.
* **CFT (Conformal Field Theory)**: This is a quantum theory that lives exclusively on the lower-dimensional, fixed boundary of the AdS space.

The "correspondence" is a mathematical duality. It states that the physics of gravity inside the hyperbolic bulk is mathematically identical to the quantum physics on the boundary. This is often explained using the **holographic principle**: just as a 2D hologram encodes all the information necessary to project a 3D image, the 2D boundary (CFT) encodes all the information contained in the 3D hyperbolic bulk (AdS). This duality turns difficult problems in quantum physics into solvable geometry problems, such as relating quantum entanglement to the area of a geometric surface.
